...
You can also set a sale order type on a website. When configured, orders
created from that website use the website sale order type instead of the
contact sale order type.
