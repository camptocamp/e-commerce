...
You can also define a sale order type directly on a website. When set,
this website sale order type takes precedence over the contact sale
order type for orders created from that website.
