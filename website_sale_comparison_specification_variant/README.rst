...
.. 
   ...
   !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
   !! source digest: sha256:b6f066f890dafd9bb0769551c6755c67a2dfa3580c651bf358110deaa052114f
   !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
the product, including non-variant-defining ("informative") attributes
whose values can be restricted to specific variant combinations via the
attribute value's "Exclude for" configuration.
...
compared product, only the value(s) compatible with that product's own
variant are listed.
...
3. On the eCommerce product page, the "Specifications" display (table
   ...
   that attribute compatible with that product's own variant.
