...
To specify a tax display preference for a partner:

1. Go to **Contacts** and open the partner.
...
For contacts linked to a company, the contact value takes precedence. If
the contact value is empty, the commercial entity value is used when
set.
...
If that partner, or its commercial entity, has a **Website Tax Display**
value, website prices are displayed with that tax mode. If no value is
