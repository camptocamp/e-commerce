...
class TestWebsiteSaleTaxSelection(WebsiteSaleCommon):
    ...
    def test_01_logged_user_partner_can_specify_tax_excluded(self):
        """Test logged-in partner can specify tax-excluded website prices."""
        self.contact_partner.website_show_line_subtotals_tax_selection = "tax_excluded"
        website = self._get_website_for_user(self.website_user)
    ...
    def test_03_contact_value_takes_precedence_over_commercial_partner(self):
        """Test contact tax display takes precedence over commercial partner."""
        self.contact_partner.website_show_line_subtotals_tax_selection = "tax_excluded"
    ...
    def test_04_commercial_partner_value_is_used_when_contact_empty(self):
        """Test commercial partner tax display applies when contact has no value."""
        self.contact_partner.website_show_line_subtotals_tax_selection = False
        self.company_partner.website_show_line_subtotals_tax_selection = "tax_included"
        website = self._get_website_for_user(self.website_user)
    ...
    def test_05_cleared_partner_value_returns_to_standard_behavior(self):
        ...
        self.contact_partner.website_show_line_subtotals_tax_selection = "tax_included"
        self.company_partner.website_show_line_subtotals_tax_selection = False
        website = self._get_website_for_user(self.website_user)
